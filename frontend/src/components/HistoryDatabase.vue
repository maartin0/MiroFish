          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>No files associated</div>
              </div>
            </div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3 "Run Simulation" and Step5 "Deep Interaction" must be launched live and do not support playback</span>
            </div>
          </div>
        </div>
      </Transition>
