            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & profile generation & agent simulation parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. If Wuhan University releases an announcement revoking a student's disciplinary action, what public opinion trends would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
